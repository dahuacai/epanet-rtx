...
namespace RTX {
  ...
  public:
    ...
    virtual std::ostream& toStream(std::ostream &stream);
     ...
     void setTableColumnNames(string &_table, string &_dateCol,string &_tagCol, string &_valueCol/*, string &_qualCo*/);//dhc add for db connect set table 2015-1-12
  ...
  protected:
    ...
    */
    ...
    class ScadaRecord {
    public:
      //SQLWCHAR tagName[MAX_SCADA_TAG];
     // SQL_TIMESTAMP_STRUCT time;
	  long time;//add for modifying  time type to unixtime-dhc 2015-1-13
	 // long _time;//add for test -dhc 2015-1-13
      double value;
      int quality;
